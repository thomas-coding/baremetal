...
set(CMAKE_C_FLAGS   "${MCPU_FLAGS} ${VFP_FLAGS} ${MBEDTLS_FLAGS} ${SPEC_FLAGS} -fdata-sections -ffunction-sections " CACHE INTERNAL "c compiler flags")
set(CMAKE_CXX_FLAGS "${MCPU_FLAGS} ${VFP_FLAGS} ${MBEDTLS_FLAGS} -fdata-sections -ffunction-sections -fno-rtti -fno-exceptions " CACHE INTERNAL "cxx compiler flags")
